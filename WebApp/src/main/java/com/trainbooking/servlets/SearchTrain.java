...
public class SearchTrain extends HttpServlet {
 ...
 out.print("<input type='text' name='trainno' value='' class='form-control' background:'transparent' placeholder='Enter Train Id'/>");
 out.print("</div>");
 out.print("<div class='form-group'>");
 out.print("<input type='submit' name='button' value='Search Train' class='form-control btn btn-primary' />");
 ...
 out.print("</form>");
  ...
  String tnou=req.getParameter("trainno");   	
  int id= Integer.parseInt(tnou);
  List<Train> list=DBTransactions.searchTrainsRecords(id);    	
if(list.isEmpty())
{
	out.print("<div class='form-group'>");
	 out.print("<input type='submit' name='button' value='No Record Found' class='form-control btn btn-danger' />");
	 out.print("</div>");
...
else
{
	 for( Train train:list)
	 {
		 ...
		 out.println("<div><tr class='bg-primary'><th scope='col'>ID</th><th scope='col'>Train Number</th><th scope='col'>Train Name</th><th scope='col'>From Station</th><th scope='col'>To Station</th><th scope='col'>Seats Available</th><th scope='col'>Fare</th><th scope='col'>Date</th></div>");
