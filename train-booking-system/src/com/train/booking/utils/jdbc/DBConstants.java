...
public class DBConstants {
	...
	public static final String DB_QUERY_1="CREATE TABLE TRAIN_DETAILS"
                                          ...
                                          + "PRIMARY KEY(ID))";
	public static final String DB_QUERY_2="insert into train_details(TRAINNUMBER,TRAINNAME ,"
			+ "FROMSTATION,TOSTATION ,SEATSAVAILABLE,FARE) values(?,?,?,?,?,?);";
	...
	public static final String DB_QUERY_5="UPDATE TRAIN_DETAILS SET TRAINNUMBER=?,TRAINNAME=?,FROMSTATION=?,TOSTATION=?, SEATSAVAILABLE=?,FARE=? WHERE ID=?" ;
